    ...
    <div className="space-y-8 w-full max-w-4xl">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <form onSubmit={handleSubmit} className="contents">
          ...
          <div className="rounded-2xl border border-emerald-500/20 bg-slate-900/50 p-5 space-y-4">
            <h2 className="text-sm font-semibold text-emerald-200">Account & credentials</h2>
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className={labelClass}>License number</label>
                <input type="text" value={data.licenseNumber ?? ""} disabled className={readOnlyClass} />
              </div>
              <div>
                <label className={labelClass}>Specialization</label>
                <input type="text" value={data.specialization ?? ""} disabled className={readOnlyClass} />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className={labelClass}>Consultation fee</label>
                <input type="text" value={data.consultationFee != null ? `$${data.consultationFee}` : "—"} disabled className={readOnlyClass} />
              </div>
              <div>
